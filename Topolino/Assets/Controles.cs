...
public partial class @Controles : IInputActionCollection2, IDisposable
{
    ...
    ""controlSchemes"": []
        ...
        m_Topolino_Pause = m_Topolino.FindAction("Pause", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_Topolino_Pause;
    public struct TopolinoActions
    {
        ...
        public InputAction @Pause => m_Wrapper.m_Topolino_Pause;
        ...
        public void SetCallbacks(ITopolinoActions instance)
        {
            if (m_Wrapper.m_TopolinoActionsCallbackInterface != null)
            {
                ...
                @Pause.started -= m_Wrapper.m_TopolinoActionsCallbackInterface.OnPause;
                @Pause.performed -= m_Wrapper.m_TopolinoActionsCallbackInterface.OnPause;
                @Pause.canceled -= m_Wrapper.m_TopolinoActionsCallbackInterface.OnPause;
            }
